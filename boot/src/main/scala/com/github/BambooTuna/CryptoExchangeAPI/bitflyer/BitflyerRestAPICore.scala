...
trait BitflyerRestAPICore extends Exchange {
  ...
  protected def encodeRequestBody[T](requestBody: T)(implicit encoder: Encoder[T]): Option[String] =
    Some(requestBody.asJson.noSpaces)

  protected def encodeQueryParameter[T](queryParameter: T)(implicit encoder: Encoder[T]): Option[String] = {
