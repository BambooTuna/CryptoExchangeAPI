...
import com.github.BambooTuna.CryptoExchangeAPI.bitflyer.protocol.rest.{CancelAllChildOrders, CancelChildOrder, GetChildOrders, GetPositions, SendChildOrder}
...
object BitflyerRestAPI {
  implicit val bitflyerRestAPI = new ExchangeRestAPI[BitflyerRestAPI] {
    def generate(apiAuth: ApiAuth): BitflyerRestAPI = new BitflyerRestAPI(apiAuth)
  }
}
